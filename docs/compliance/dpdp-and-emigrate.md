...
| DPDP *engineering readiness* | **7.0** | Controls exist for consent, purposes, rights, age gate, private storage, erasure cascade (hold-aware). Access export is a JSON package, not every blob. Not a Board filing, not Rule 3-complete, not a 2027 attestation. |
...
known. The first-paint banner requires I agree (Terms, Privacy, 18+) before
Log in / Get Started (Decline blocks OAuth). That is not verifiable parental
consent and a minor can still click I agree. Commitment APIs
