...
7. Analytics off by default; cookie banner is **Allow** / **Reject** only. Browser choice syncs to `users.cookiesEnabled` on login; rail must not overwrite a prior Allow.
