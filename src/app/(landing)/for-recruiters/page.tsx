    ...
    >
      ...
      >
        ...
        <DocSection id="ai-ecosystem" number="03" title="The AI ecosystem">
          <p>
            One platform. Multiple agents. The same model fabric powers every
            step of the pipeline so quality stays consistent from first profile
            field to final shortlist.
          </p>
          <DocFeatureGrid
            items={[
              {
          ...
          <DocTable
            ...
            rows={[
              ...
              [
                "Domain interview",
                "Ad-hoc technical chats with uneven notes",
              ],
              [
                "Custom questions",
                "Scattered Google Forms and email threads",
              ],
              ["JD generator", "Blank-page writing and template hunting"],
              [
                "KYC vision checks",
                "Blind document dumps into shared drives",
              ],
            ]}
          />
        </DocSection>
        ...
        <DocSection id="who-you-hire" number="05" title="Who you hire here">
          <p>
            ...
            electricians, welders, drivers, technicians, facilities,
            construction, hospitality, and similar crafts — often seeking Gulf
            and other cross-border placements.
          </p>
          <DocList
            items={[
