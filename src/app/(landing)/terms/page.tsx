...
export const metadata = {
  title: "Terms of Service · Gulf Path",
  description:
    "Terms governing use of the Gulf Path platform for candidates and hirers.",
};
      ...
      <LegalDoc title="Terms of Service" updated="July 12, 2026">
        <LegalSection title="1. Agreement">
          <p>
            ...
            Gulf Path’s websites, products, and services (the “Service”). By
        ...
        <LegalSection title="2. Accounts and profile types">
          <p>
            You may use Gulf Path as a candidate (“work” profile) or as a hirer
        ...
        <LegalSection title="5. AI features">
          <p>
            Gulf Path offers AI-assisted interviews and related analysis. AI
        ...
        <LegalSection title="7. Content you provide">
          <p>
            ...
            job descriptions, and interview responses). You grant Gulf Path a
        ...
        <LegalSection title="9. Disclaimers">
          <p>
            ...
            extent permitted by law, Gulf Path disclaims warranties of
        ...
        <LegalSection title="10. Limitation of liability">
          <p>
            To the fullest extent permitted by law, Gulf Path and its affiliates
